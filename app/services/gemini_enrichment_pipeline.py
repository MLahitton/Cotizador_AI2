...
def _enriched_to_gemini_element(item: GeminiElementEnrichment, index: int) -> GeminiElement:
    return GeminiElement(
        ...
        modulation=item.modulation_raw,
        opening_direction=item.opening_direction_raw,
        special_features=list(item.special_features),
        quantity=item.quantity,
        quantity_status=item.quantity_status,
        quantity_confidence=item.quantity_confidence,
        quantity_notes=item.quantity_notes,
