...
PDF_PATH = ROOT_DIR / "manual_tests" / "haras.pdf"
RESULTS_DIR = ROOT_DIR / "manual_tests" / "results"
BATCHES_DIR = RESULTS_DIR / "haras_batches"
DISCOVERY_OUTPUT_PATH = RESULTS_DIR / "haras_full_discovery.json"
ENRICHMENT_OUTPUT_PATH = RESULTS_DIR / "haras_full_enrichment.json"
EXTRACTION_OUTPUT_PATH = RESULTS_DIR / "haras_full_requirement_extraction.json"
REPORT_OUTPUT_PATH = RESULTS_DIR / "haras_full_pipeline_report.md"
SCOPE_OUTPUT_PATH = RESULTS_DIR / "haras_full_scope.json"
...
def main() -> int:
    ...
    try:
        ...
        extraction = provider.extract_with_discovery_from_files(
            [PDF_PATH],
            project_id="manual-haras",
            requirement_id="manual-haras-001",
...
def _build_report(
    ...
    return f"""# HARAS - FULL AI2 PIPELINE REPORT
